...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
    ...
    private void init() {
        ...
        mLac = new LayoutAnimationController(animation, 0);
        mLac.setInterpolator(new BounceInterpolator());
    }
    ...
    public View onCreateView() {
        ...
        // cancelDivider.setBackgroundColor(Color.parseColor("#ffefefef"));  // 取消上面间隔线的颜色
        LayoutParams clp = new LayoutParams(LayoutParams.MATCH_PARENT, 18);
        ...
        // 添加底部间距
        ImageView bottomDivider = new ImageView(mContext);
        bottomDivider.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 20));
        ll_container.addView(bottomDivider);
